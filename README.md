...
|----------------------|-------------|---------------|------------------|
| OTEL_SERVICE_NAME | Set service name tag for all opentelemetry metric and traces | - | - |
| OTEL_RESOURCE_ATTRIBUTES | Set additional tag / label for all opentelemetry metric and traces | - | Format: `key1=value1,key2=value2` |
